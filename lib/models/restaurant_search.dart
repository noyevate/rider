...
List<RestaurantSearch> restaurantSearchFromJson(String str) => List<RestaurantSearch>.from(json.decode(str).map((x) => RestaurantSearch.fromJson(x)));

String restaurantSearchToJson(List<RestaurantSearch> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
