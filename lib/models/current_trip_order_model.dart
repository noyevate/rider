...
//
//     final currentTripOrderModel = currentTripOrderModelFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

CurrentTripOrderModel currentTripOrderModelFromJson(String str) => CurrentTripOrderModel.fromJson(json.decode(str));

String currentTripOrderModelToJson(CurrentTripOrderModel data) => json.encode(data.toJson());

class CurrentTripOrderModel {
    final String id;
    final String userId;
    ...
    factory CurrentTripOrderModel.fromJson(Map<String, dynamic> json) => CurrentTripOrderModel(
        id: json["_id"],
        userId: json["userId"],
