...
import 'package:rider/models/ddriver_licence_image_update.dart';
                ...
                Column(
                  ...
                  children: [
                    Center(
                      child: GestureDetector(
                          onTap: () {
                            uploadController.pickImage("three");
                          },
                          child: Obx(
                            () => CustomPaint(
                              ...
                              child: CircleAvatar(
                                ...
                                child: ClipOval(
                                  child: uploadController.imageThreeUrl == '' ? Center(
                                    child: Container(
                                        height: 96.h,
                                        width: 96.w,
                                        decoration: BoxDecoration(
                                      ...
                                      alignment: Alignment.topLeft,
                                      children: [
                                        Image.network(uploadController.imageThreeUrl,
                                            fit: BoxFit.cover,
                                            width: 400.w,
                                            height: 400.h),
                    ...
                    ReuseableText(
                      title: "Take a clear picture of your driver’s license ",
                      style: TextStyle(
                        color: Tcolor.Text,
                        fontSize: 25.sp,
                    ...
                    Obx(() => CustomButton(
                        ...
                        btnColor: uploadController.imageThreeUrl != ''   ? Tcolor.PRIMARY_Button_color_2 : Color.fromRGBO(193, 193, 193, 1),
                        btnWidth: MediaQuery.of(context).size.width / 1.1,
                        btnHeight: 90.h,
                        raduis: 100.r,
                        fontSize: 32.sp,
                        showArrow: false,
                        onTap: uploadController.imageThreeUrl != '' 
                            ? () {
                              print(uploadController.imageThreeUrl);
                              print(riderId);
                              DriverLicienceUpdateUrl model = DriverLicienceUpdateUrl(driverLicenseImageUrl: uploadController.imageThreeUrl);
                                  String data = driverLicienceUpdateUrlToJson(model);
                                  profileController.updateDriverLicense(data, riderId);
                              }
                            : null),)
