...
import 'package:rider/models/vehicle_image.dart';
...
class VehiclePicture extends StatelessWidget {
  const VehiclePicture({super.key});
      ...
      children: [
        Scaffold(
          appBar: PreferredSize(
              ...
              child: Center(
                child: ReuseableText(
                  title: "Update Vehicle’s Picture ",
                  style: TextStyle(
                    color: Tcolor.Text,
                    fontSize: 40.sp,
                ...
                Column(
                  ...
                  children: [
                          ...
                          child: Obx(
                            () => CustomPaint(
                              ...
                              child: CircleAvatar(
                                ...
                                child: ClipOval(
                                  child: uploadController.imageOneUrl == '' ? Center(
                                    child: Container(
                                        height: 96.h,
                                        width: 96.w,
                                        decoration: BoxDecoration(
                                      ...
                                      alignment: Alignment.topLeft,
                                      children: [
                                        Image.network(uploadController.imageOneUrl,
                                            fit: BoxFit.cover,
                                            width: 400.w,
                                            height: 400.h),
                    ...
                    Obx(() => CustomButton(
                        ...
                        btnColor: uploadController.imageOneUrl != ''   ? Tcolor.PRIMARY_Button_color_2 : Color.fromRGBO(193, 193, 193, 1),
                        btnWidth: MediaQuery.of(context).size.width / 1.1,
                        btnHeight: 90.h,
                        raduis: 100.r,
                        fontSize: 32.sp,
                        showArrow: false,
                        onTap: uploadController.imageOneUrl != '' 
                            ? () {
                              VehicleImageUrl model = VehicleImageUrl(vehicleImgUrl: uploadController.imageOneUrl);
                              String data = vehicleImageUrlToJson(model);
                              profileController.updateVehicleImage(data, riderId);
                              }
                            : () {
                              print(userImageUrl);
                            }),)
