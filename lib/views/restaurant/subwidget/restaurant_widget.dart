                ...
                Align(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: Colors.white54, // Semi-transparent overla
                    ),
                    child: Column(
                      children: [
                        ReuseableText(
                ...
                Padding(
                    ...
                    child: Align(
                      ...
                      child: Container(
                        height: 44.h,
                        width: 140.w,
                        color: restaurant.isAvailabe ? Color.fromRGBO(8, 102, 52, 0.75) : Color.fromRGBO(218, 0, 0, 0.75),
                        child: Center(
                          child: ReuseableText(
                            title: restaurant.isAvailabe ? "OPEN" : "CLOSED",
                            style: TextStyle(
                              fontSize: 24.sp,
                              fontWeight: FontWeight.w600,
                              color: Tcolor.White,
