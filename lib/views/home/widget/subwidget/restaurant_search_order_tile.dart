...
import 'package:rider/views/home/widget/subwidget/restaurant_search_order_details.dart';
...
class RestaurantSearchOrderTile extends HookWidget {
  const RestaurantSearchOrderTile({super.key, required this.order});
                      ...
                      onTap: orderRestaurant.value != null &&
                          ...
                          ? () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => RestaurantSearchOrderDetails(
