...
class OrderTile extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final riderLatitude = box.read("presentLat");
    final riderLongitude = box.read("presentLng");
    ...
    if(orderRestaurant.value != null && riderLatitude != null && riderLongitude != null ) {
       riderToRestaurant = Geolocator.distanceBetween(
        orderRestaurant.value!.coords.latitude,
        orderRestaurant.value!.coords.longitude,
        riderLatitude, 
        riderLongitude);
                        ...
                        children: [
                          ...
                          ReuseableText(
                            title: orderRestaurant.value == null
                              ...
                              : "Drop off (${(riderToRestaurant/ 1000).round()}km away from restaurant)",
                              // title: ,
                              style: TextStyle(
